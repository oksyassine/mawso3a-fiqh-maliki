...
add_masala(0, t0a,
    ...
    dalil=[{
        'type': 'حديث',
        'full_text': 'وقد توضأ رسول الله ﷺ بمد وهو وزن رطل وثلث وتطهر بصاع وهو أربعة أمداد بمده ﷺ',
        'summary': 'مقدار ماء الوضوء والغسل — المد والصاع',
        'page_id': 11,
...
add_masala(1, t1b,
    ...
    dalil=[
        {
            'type': 'حديث',
            'full_text': 'قال رسول الله ﷺ: ويل للأعقاب من النار',
        ...
        {
            'type': 'قول مالك',
            'full_text': 'ليس عليه تخليل اللحية في الوضوء في قول مالك',
...
add_masala(1, t1c,
    ...
    dalil=[{
        'type': 'حديث',
        'full_text': 'قال رسول الله ﷺ: من توضأ فأحسن الوضوء ثم رفع طرفه إلى السماء فقال أشهد أن لا إله إلا الله وحده لا شريك له وأشهد أن محمدا عبده ورسوله فتحت له أبواب الجنة الثمانية يدخل من أيها شاء',
